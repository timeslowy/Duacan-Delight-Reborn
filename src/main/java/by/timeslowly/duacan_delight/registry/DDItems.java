...
public class DDItems {
    ...
    public static final DeferredItem<Item> SOYBEAN_MILK_FLUID_BUCKET = REGISTRY.register("soybean_milk_fluid_bucket", () -> new BucketItem(DDFluids.SOYBEAN_MILK_FLUID.get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.COMMON)));
    public static final DeferredItem<Item> TEAOIL_FLUID_BUCKET = REGISTRY.register("teaoil_fluid_bucket", () -> new BucketItem(DDFluids.TEAOIL_FLUID.get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.COMMON)));
